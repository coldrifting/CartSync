...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Aisle", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Item", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Joins.ItemAisle", b =>
                {
                    b.Property<string>("ItemId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Joins.ItemPrep", b =>
                {
                    b.Property<string>("ItemId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Prep", b =>
                {
                    b.Property<string>("PrepId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Recipe", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.RecipeInstruction", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.RecipeSection", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.RecipeSectionEntry", b =>
                {
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Store", b =>
                {
                    b.Property<string>("StoreId")
                        .HasMaxLength(26)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Aisle", b =>
                {
                    b.HasOne("CartSyncBackend.Models.Store", "Store")
                        .WithMany("Aisles")
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Joins.ItemAisle", b =>
                {
                    b.HasOne("CartSyncBackend.Models.Aisle", "Aisle")
                        .WithMany()
                        .HasForeignKey("AisleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CartSyncBackend.Models.Item", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("CartSyncBackend.Models.Joins.ItemPrep", b =>
                {
                    ...
                    b.HasOne("CartSyncBackend.Models.Prep", "Prep")
                        .WithMany("ItemPreps")
            ...
            modelBuilder.Entity("CartSyncBackend.Models.RecipeInstruction", b =>
                {
                    b.HasOne("CartSyncBackend.Models.Recipe", "Recipe")
            ...
            modelBuilder.Entity("CartSyncBackend.Models.RecipeSectionEntry", b =>
                {
                    ...
                    b.HasOne("CartSyncBackend.Models.RecipeSection", "RecipeSection")
                        .WithMany("RecipeSectionEntries")
