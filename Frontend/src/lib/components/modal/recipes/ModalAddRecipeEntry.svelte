<script lang="ts">
    ...
    let {sections, items, scrollOnAdd = undefined}: Props = $props();
...
<Modal body
       ...
       on:open={() => document.getElementById("sectionIdSelect")?.focus()}
       keyboard={allowEscapeKey}
       centered={true}>
    <form method="POST"
          action="?/addRecipeEntry"
          use:trapFocus={true}
          use:enhance={submitFunction}>
        <ModalHeaderCustom title="Add Ingredient" bind:isOpen={isOpen}  />
        <div>
